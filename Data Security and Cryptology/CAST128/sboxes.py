...
"""this function return the value from S-Box
    first split the inputValue to first 5 binary numbers and 3 least significant binary numbers
    the 5 for row and 3 for column according to that get the value from the sboxes[sboxNumber] 
    and return the value as binary"""
def calculatingSboxOutput(sboxNumber, inputValue):
    sbox = sboxes[sboxNumber - 1]
